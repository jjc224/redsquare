...
${OBJECTDIR}/_ext/583062117/CompressUtils.o: ../FileArchiver/CompressUtils.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/CompressUtils.o ../FileArchiver/CompressUtils.cpp

${OBJECTDIR}/_ext/583062117/DBConnector.o: ../FileArchiver/DBConnector.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/DBConnector.o ../FileArchiver/DBConnector.cpp
...
${OBJECTDIR}/_ext/583062117/FileLib.o: ../FileArchiver/FileLib.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/FileLib.o ../FileArchiver/FileLib.cpp

${OBJECTDIR}/_ext/583062117/FileRecord.o: ../FileArchiver/FileRecord.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/FileRecord.o ../FileArchiver/FileRecord.cpp

${OBJECTDIR}/_ext/583062117/MurmurHash3.o: ../FileArchiver/MurmurHash3.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/MurmurHash3.o ../FileArchiver/MurmurHash3.cpp

${OBJECTDIR}/_ext/583062117/TestUtilities.o: ../FileArchiver/TestUtilities.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/TestUtilities.o ../FileArchiver/TestUtilities.cpp

${OBJECTDIR}/_ext/583062117/Utilities.o: ../FileArchiver/Utilities.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/Utilities.o ../FileArchiver/Utilities.cpp

${OBJECTDIR}/_ext/583062117/VersionRecord.o: ../FileArchiver/VersionRecord.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/583062117
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/583062117/VersionRecord.o ../FileArchiver/VersionRecord.cpp
