...
// TODO
void newtestclass::testGetHash()
{
    /*std::string path;
    FileLib fileLib;
    unsigned int result = fileLib.GetHash(path);*/
}

void newtestclass::testGetModifiedDate()
{
    /*std::string path;
    FileLib fileLib;
    time_t result = fileLib.GetModifiedDate(path);*/
    
    // ASSERT
}

void newtestclass::testGetPath()
{
...
void newtestclass::testNormalize()
{
    const std::size_t NUM_PATH_ELEMENTS = 5;
...
void newtestclass::testSplitPath()
{
    const std::size_t NUM_PATH_ELEMENTS = 5;
...
std::string newtestclass::generateUnormalizedPath(const std::string elements[], const std::size_t SIZE)
{
